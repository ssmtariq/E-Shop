...
<html>
<head>
	<c:if test='${criteria=="latest"}'>
		<c:import url="/resource/layout/layoutHeader.jsp">
			<c:param name="pageTitle" value="latestProduct.title"></c:param>
		</c:import>
	</c:if>
	<c:if test='${criteria=="featured"}'>
		<c:import url="/resource/layout/layoutHeader.jsp">
			<c:param name="pageTitle" value="featuredProduct.title"></c:param>
		</c:import>
	</c:if>
	<c:if test='${criteria=="upcoming"}'>
		<c:import url="/resource/layout/layoutHeader.jsp">
			<c:param name="pageTitle" value="upcomingProduct.title"></c:param>
		</c:import>
	</c:if>
	<c:if test='${criteria=="topSale"}'>
		<c:import url="/resource/layout/layoutHeader.jsp">
			<c:param name="pageTitle" value="topSaleProduct.title"></c:param>
		</c:import>
	</c:if>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(criteria=="latest"){
				...
				url = 'product.do?method=latestProducts';
				imageUrl = 'product.do?method=latestProductImages';
			}else if (criteria=="featured") {
				url = 'product.do?method=featuredProducts';
				imageUrl = 'product.do?method=featuredProductsImages';
			}else if (criteria=="upcoming") {
				url = 'product.do?method=upcomingProducts';
				imageUrl = 'product.do?method=upcomingProductsImages';
			}else if (criteria=="topSale") {
				url = 'product.do?method=topSaleProducts';
				imageUrl = 'product.do?method=topSaleProductsImages';
			}
			$.ajax({                                            
		        url: url,   
		        data: { },
