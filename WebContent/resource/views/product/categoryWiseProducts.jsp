...
<head>
	<c:import url="/resource/layout/layoutHeader.jsp">
		<c:param name="pageTitle" value="criteriaWiseProduct.header"></c:param>
	</c:import>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			var url = 'product.do?method=getCategoryWiseProducts&categoryId='+categoryId;
			var imageUrl = 'product.do?method=getCategoryWiseProductImages&categoryId='+categoryId;
			$.ajax({                                            
		        url: url,   
		        data: {},
				dataType : 'json',
