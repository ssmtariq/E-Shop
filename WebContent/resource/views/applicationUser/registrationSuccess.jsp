	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 col-sm-8 col-xs-12">
				<div class="reg">
					<h3 class="text-center section-title">Registration Success</h3>
					<blockquote>
						<h3>
					...
					<p>Welcome, please check your email to confirm your registration. Then 
						<a href="${pageContext.request.contextPath}/user.do?method=signIn">click here to sign-in.</a>
					</p>
